...
public class TimeLine extends View {
     ...
     * 物流开始节点图标
     */
    private Drawable firstDrawabel;
    /**
     * 物流结束节点图标
     */
    ...
    private void init() {
        ...
        firstDrawabel = getResources().getDrawable(R.drawable.first_point);
        otherDrawable = getResources().getDrawable(R.drawable.other_point);
